...
- **status**: P-NEW-2 / P-NEW-7 resolved by spec 036 (commit 14fc3c20)、 P-NEW-1 resolved by spec 037 (commit 7cca9c0)、 **P-NEW-3 Closed (= 2026-06-30、 spec 038 Phase 1 観察で EVENT 21 = 0 件 / 42h で ROI 0 確定、 ERXUDP timeout 主因は RX 待ちと判明、 詳細 = memory feedback-phase1-event21-zero-erxudp-rx-dominant)**、 **P-NEW-4 Closed (= 2026-06-28、 spec 039 SKSAVE + SFF=1 deploy 直後 revert)**、 P-NEW-5 判定保留 (= 2026-06-30、 spec 040 Phase 1 観察で sk_event_25_total = 0 件、 ただし bridge 既存 bug `_wait_skjoin_event25` で on_sk_event 未呼出 = 観察基盤崩壊、 spec 044 fix 後の再観察待ち、 詳細 = memory feedback-bridge-skjoin-event25-not-counted)、 spec 041 (= silent death watchdog) 2026-06-28 Phase 2a Deployed、 spec 042 (= P-NEW-8 SKADDNBR) 2026-06-28 起票、 spec 044 (= bug fix) 起票予定、 残 P-NEW-6/8/9 = P-NEW-8 起票済、 P-NEW-6/9 open
